...
namespace Linphone
{
    ...
    public class CallListener : LinphoneObject
    {
...
#endif
        private static void on_encryption_changed(IntPtr call, int on, string authenticationToken)
        {
            Call thiz = fromNativePtr<Call>(call);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        private delegate void OnAckProcessingDelegatePrivate(IntPtr call, IntPtr ack, int isReceived);
...
#endif
        private static void on_ack_processing(IntPtr call, IntPtr ack, int isReceived)
        {
            Call thiz = fromNativePtr<Call>(call);
...
#endif
        private static void on_call_encryption_changed(IntPtr lc, IntPtr call, int on, string authenticationToken)
        {
            Core thiz = fromNativePtr<Core>(lc);
    ...
    public class Core : LinphoneObject
    {
        ...
        /// <summary>
        /// Initiates an outgoing call The application doesn't own a reference to the
        ...
        {
            return linphone_core_video_supported(nativePtr) == 0 ? false : true;
        }
        [DllImport(LinphoneWrapper.LIB_NAME)]
